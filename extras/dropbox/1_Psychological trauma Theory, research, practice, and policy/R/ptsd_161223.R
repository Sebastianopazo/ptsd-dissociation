...
data1 <- mydata[c(-1,-2,-5,-14,-15)] #select numeric variables for correlation
cor(x = data1, use = "na.or.complete")
data2 <- cor(x = data1, use = "na.or.complete")
