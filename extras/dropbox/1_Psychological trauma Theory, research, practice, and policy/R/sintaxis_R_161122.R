...
####### Proyect XXXXX: Test 2 mediational models:
#III.1: PDEQ_t0 (dissociation) mediates TQ_t0 (traumatic load) -> PCL_t1 (PTSD 1 month after)  
#III.2: PDEQ_t0 (dissociation) mediates TQ_t0 (traumatic load) -> BDI_t1 (depression 1 month after)
