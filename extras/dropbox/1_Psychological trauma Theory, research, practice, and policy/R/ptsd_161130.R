...
#PC EPUC
setwd("C:/Users/user/Dropbox/1 PROYECTOS_INVESTIGACION/desastres_naturales/paper factores riesgo PTSD Rodrigo")
...
###### PREPARING VARIABLES (run always)####
...
## Will test 4 mediational models:
